 ...
 */
export function instanceOfPokemonShapeDetailAwesomeNamesInner(
  value: object
): value is PokemonShapeDetailAwesomeNamesInner {
  if (!("awesomeName" in value) || value["awesomeName"] === undefined)
    return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function PokemonShapeDetailAwesomeNamesInnerFromJSON(
  json: any
): PokemonShapeDetailAwesomeNamesInner {
  return PokemonShapeDetailAwesomeNamesInnerFromJSONTyped(json, false);
}

export function PokemonShapeDetailAwesomeNamesInnerFromJSONTyped(
  json: any,
...
export function PokemonShapeDetailAwesomeNamesInnerToJSON(
  value?: PokemonShapeDetailAwesomeNamesInner | null
): any {
  if (value == null) {
    return value;
  }
