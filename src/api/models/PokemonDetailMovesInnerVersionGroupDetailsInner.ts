 ...
 */
export function instanceOfPokemonDetailMovesInnerVersionGroupDetailsInner(
  value: object
): value is PokemonDetailMovesInnerVersionGroupDetailsInner {
  if (!("levelLearnedAt" in value) || value["levelLearnedAt"] === undefined)
    return false;
  if (!("moveLearnMethod" in value) || value["moveLearnMethod"] === undefined)
    return false;
...
export function PokemonDetailMovesInnerVersionGroupDetailsInnerFromJSON(
  json: any
): PokemonDetailMovesInnerVersionGroupDetailsInner {
  return PokemonDetailMovesInnerVersionGroupDetailsInnerFromJSONTyped(
    json,
    false
  );
}

export function PokemonDetailMovesInnerVersionGroupDetailsInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    moveLearnMethod: AbilityDetailPokemonInnerPokemonFromJSON(
...
export function PokemonDetailMovesInnerVersionGroupDetailsInnerToJSON(
  value?: PokemonDetailMovesInnerVersionGroupDetailsInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    move_learn_method: AbilityDetailPokemonInnerPokemonToJSON(
