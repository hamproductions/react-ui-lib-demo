 ...
 */
export function instanceOfMoveChangeEffectEntriesInner(
  value: object
): value is MoveChangeEffectEntriesInner {
  if (!("effect" in value) || value["effect"] === undefined) return false;
  if (!("shortEffect" in value) || value["shortEffect"] === undefined)
    return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function MoveChangeEffectEntriesInnerFromJSON(
  json: any
): MoveChangeEffectEntriesInner {
  return MoveChangeEffectEntriesInnerFromJSONTyped(json, false);
}

export function MoveChangeEffectEntriesInnerFromJSONTyped(
  json: any,
...
export function MoveChangeEffectEntriesInnerToJSON(
  value?: MoveChangeEffectEntriesInner | null
): any {
  if (value == null) {
    return value;
  }
