 ...
 */
export function instanceOfMoveDetailMeta(
  value: object
): value is MoveDetailMeta {
...
export function MoveDetailMetaFromJSONTyped(
  json: any,
  ...
  return {
    ...
    ailmentChance:
      json["ailment_chance"] == null ? undefined : json["ailment_chance"],
    flinchChance:
      json["flinch_chance"] == null ? undefined : json["flinch_chance"],
