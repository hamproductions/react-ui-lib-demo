...
export function PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerToJSON(value?: PokemonEncountersRetrieve200ResponseInnerVersionDetailsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
