 ...
 */
export function instanceOfPokemonColorDetail(
  value: object
): value is PokemonColorDetail {
...
export function PokemonColorDetailFromJSONTyped(
  json: any,
...
export function PokemonColorDetailToJSON(
  value?: Omit<PokemonColorDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
