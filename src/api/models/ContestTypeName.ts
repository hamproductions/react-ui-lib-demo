 ...
 */
export function instanceOfContestTypeName(
  value: object
): value is ContestTypeName {
...
export function ContestTypeNameFromJSONTyped(
  json: any,
...
export function ContestTypeNameToJSON(value?: ContestTypeName | null): any {
  if (value == null) {
    return value;
  }
  return {
