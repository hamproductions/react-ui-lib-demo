 ...
 */
export function instanceOfPokemonDetailPastAbilitiesInner(
  value: object
): value is PokemonDetailPastAbilitiesInner {
...
export function PokemonDetailPastAbilitiesInnerFromJSON(
  json: any
): PokemonDetailPastAbilitiesInner {
  return PokemonDetailPastAbilitiesInnerFromJSONTyped(json, false);
}

export function PokemonDetailPastAbilitiesInnerFromJSONTyped(
  json: any,
...
export function PokemonDetailPastAbilitiesInnerToJSON(
  value?: PokemonDetailPastAbilitiesInner | null
): any {
  if (value == null) {
    return value;
  }
