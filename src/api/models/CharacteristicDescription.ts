 ...
 */
export function instanceOfCharacteristicDescription(
  value: object
): value is CharacteristicDescription {
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function CharacteristicDescriptionFromJSON(
  json: any
): CharacteristicDescription {
  return CharacteristicDescriptionFromJSONTyped(json, false);
}

export function CharacteristicDescriptionFromJSONTyped(
  json: any,
...
export function CharacteristicDescriptionToJSON(
  value?: CharacteristicDescription | null
): any {
  if (value == null) {
    return value;
  }
