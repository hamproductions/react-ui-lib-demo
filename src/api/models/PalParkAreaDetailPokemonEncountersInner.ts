 ...
 */
export function instanceOfPalParkAreaDetailPokemonEncountersInner(
  value: object
): value is PalParkAreaDetailPokemonEncountersInner {
...
export function PalParkAreaDetailPokemonEncountersInnerFromJSON(
  json: any
): PalParkAreaDetailPokemonEncountersInner {
  return PalParkAreaDetailPokemonEncountersInnerFromJSONTyped(json, false);
}

export function PalParkAreaDetailPokemonEncountersInnerFromJSONTyped(
  json: any,
...
export function PalParkAreaDetailPokemonEncountersInnerToJSON(
  value?: PalParkAreaDetailPokemonEncountersInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    "pokemon-species": AbilityDetailPokemonInnerPokemonToJSON(
