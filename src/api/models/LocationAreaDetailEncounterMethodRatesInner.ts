 ...
 */
export function instanceOfLocationAreaDetailEncounterMethodRatesInner(
  value: object
): value is LocationAreaDetailEncounterMethodRatesInner {
  if (!("encounterMethod" in value) || value["encounterMethod"] === undefined)
    return false;
...
export function LocationAreaDetailEncounterMethodRatesInnerFromJSON(
  json: any
): LocationAreaDetailEncounterMethodRatesInner {
  return LocationAreaDetailEncounterMethodRatesInnerFromJSONTyped(json, false);
}

export function LocationAreaDetailEncounterMethodRatesInnerFromJSONTyped(
  json: any,
  ...
  return {
    encounterMethod: AbilityDetailPokemonInnerPokemonFromJSON(
...
export function LocationAreaDetailEncounterMethodRatesInnerToJSON(
  value?: LocationAreaDetailEncounterMethodRatesInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    encounter_method: AbilityDetailPokemonInnerPokemonToJSON(
