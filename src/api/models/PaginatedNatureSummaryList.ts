 ...
 */
export function instanceOfPaginatedNatureSummaryList(
  value: object
): value is PaginatedNatureSummaryList {
  return true;
}

export function PaginatedNatureSummaryListFromJSON(
  json: any
): PaginatedNatureSummaryList {
  return PaginatedNatureSummaryListFromJSONTyped(json, false);
}

export function PaginatedNatureSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(NatureSummaryFromJSON),
  };
}

export function PaginatedNatureSummaryListToJSON(
  value?: PaginatedNatureSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(NatureSummaryToJSON),
  };
}
