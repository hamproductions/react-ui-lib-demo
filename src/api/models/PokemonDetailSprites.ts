 ...
 */
export function instanceOfPokemonDetailSprites(
  value: object
): value is PokemonDetailSprites {
  return true;
}
...
export function PokemonDetailSpritesFromJSONTyped(
  json: any,
  ...
  return {
    ...json,
    frontDefault:
      json["front_default"] == null ? undefined : json["front_default"],
  };
}

export function PokemonDetailSpritesToJSON(
  value?: PokemonDetailSprites | null
): any {
  if (value == null) {
    return value;
  }
