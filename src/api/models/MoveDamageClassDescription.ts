 ...
 */
export function instanceOfMoveDamageClassDescription(
  value: object
): value is MoveDamageClassDescription {
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function MoveDamageClassDescriptionFromJSON(
  json: any
): MoveDamageClassDescription {
  return MoveDamageClassDescriptionFromJSONTyped(json, false);
}

export function MoveDamageClassDescriptionFromJSONTyped(
  json: any,
...
export function MoveDamageClassDescriptionToJSON(
  value?: MoveDamageClassDescription | null
): any {
  if (value == null) {
    return value;
  }
