 ...
 */
export function instanceOfContestEffectEffectText(
  value: object
): value is ContestEffectEffectText {
  if (!("effect" in value) || value["effect"] === undefined) return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function ContestEffectEffectTextFromJSON(
  json: any
): ContestEffectEffectText {
  return ContestEffectEffectTextFromJSONTyped(json, false);
}

export function ContestEffectEffectTextFromJSONTyped(
  json: any,
...
export function ContestEffectEffectTextToJSON(
  value?: ContestEffectEffectText | null
): any {
  if (value == null) {
    return value;
  }
