...
export function instanceOfBerryDetail(value: object): value is BerryDetail {
  ...
  if (!("growthTime" in value) || value["growthTime"] === undefined)
    return false;
  if (!("maxHarvest" in value) || value["maxHarvest"] === undefined)
    return false;
  if (!("naturalGiftPower" in value) || value["naturalGiftPower"] === undefined)
    return false;
  if (!("size" in value) || value["size"] === undefined) return false;
  if (!("smoothness" in value) || value["smoothness"] === undefined)
    return false;
  if (!("soilDryness" in value) || value["soilDryness"] === undefined)
    return false;
  ...
  if (!("naturalGiftType" in value) || value["naturalGiftType"] === undefined)
    return false;
  return true;
}
...
export function BerryDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    flavors: (json["flavors"] as Array<any>).map(
      BerryDetailFlavorsInnerFromJSON
    ),
...
export function BerryDetailToJSON(value?: Omit<BerryDetail, "id"> | null): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    flavors: (value["flavors"] as Array<any>).map(
      BerryDetailFlavorsInnerToJSON
    ),
