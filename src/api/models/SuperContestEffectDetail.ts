 ...
 */
export function instanceOfSuperContestEffectDetail(
  value: object
): value is SuperContestEffectDetail {
...
export function SuperContestEffectDetailFromJSON(
  json: any
): SuperContestEffectDetail {
  return SuperContestEffectDetailFromJSONTyped(json, false);
}

export function SuperContestEffectDetailFromJSONTyped(
  json: any,
...
export function SuperContestEffectDetailToJSON(
  value?: Omit<SuperContestEffectDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
