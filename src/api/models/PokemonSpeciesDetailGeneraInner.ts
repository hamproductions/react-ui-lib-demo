 ...
 */
export function instanceOfPokemonSpeciesDetailGeneraInner(
  value: object
): value is PokemonSpeciesDetailGeneraInner {
  if (!("genus" in value) || value["genus"] === undefined) return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function PokemonSpeciesDetailGeneraInnerFromJSON(
  json: any
): PokemonSpeciesDetailGeneraInner {
  return PokemonSpeciesDetailGeneraInnerFromJSONTyped(json, false);
}

export function PokemonSpeciesDetailGeneraInnerFromJSONTyped(
  json: any,
...
export function PokemonSpeciesDetailGeneraInnerToJSON(
  value?: PokemonSpeciesDetailGeneraInner | null
): any {
  if (value == null) {
    return value;
  }
