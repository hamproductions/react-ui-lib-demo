 ...
 */
export function instanceOfAbilityDetailPokemonInner(
  value: object
): value is AbilityDetailPokemonInner {
...
export function AbilityDetailPokemonInnerFromJSON(
  json: any
): AbilityDetailPokemonInner {
  return AbilityDetailPokemonInnerFromJSONTyped(json, false);
}

export function AbilityDetailPokemonInnerFromJSONTyped(
  json: any,
...
export function AbilityDetailPokemonInnerToJSON(
  value?: AbilityDetailPokemonInner | null
): any {
  if (value == null) {
    return value;
  }
