 ...
 */
export function instanceOfItemFlavorText(
  value: object
): value is ItemFlavorText {
...
export function ItemFlavorTextFromJSONTyped(
  json: any,
...
export function ItemFlavorTextToJSON(value?: ItemFlavorText | null): any {
  if (value == null) {
    return value;
  }
  return {
