 ...
 */
export function instanceOfEvolutionTriggerDetail(
  value: object
): value is EvolutionTriggerDetail {
...
export function EvolutionTriggerDetailFromJSON(
  json: any
): EvolutionTriggerDetail {
  return EvolutionTriggerDetailFromJSONTyped(json, false);
}

export function EvolutionTriggerDetailFromJSONTyped(
  json: any,
...
export function EvolutionTriggerDetailToJSON(
  value?: Omit<EvolutionTriggerDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
