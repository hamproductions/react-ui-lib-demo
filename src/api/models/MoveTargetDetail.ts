 ...
 */
export function instanceOfMoveTargetDetail(
  value: object
): value is MoveTargetDetail {
...
export function MoveTargetDetailFromJSONTyped(
  json: any,
...
export function MoveTargetDetailToJSON(
  value?: Omit<MoveTargetDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
