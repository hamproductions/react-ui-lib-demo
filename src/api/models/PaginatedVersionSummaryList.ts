 ...
 */
export function instanceOfPaginatedVersionSummaryList(
  value: object
): value is PaginatedVersionSummaryList {
  return true;
}

export function PaginatedVersionSummaryListFromJSON(
  json: any
): PaginatedVersionSummaryList {
  return PaginatedVersionSummaryListFromJSONTyped(json, false);
}

export function PaginatedVersionSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(VersionSummaryFromJSON),
  };
}

export function PaginatedVersionSummaryListToJSON(
  value?: PaginatedVersionSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(VersionSummaryToJSON),
  };
}
