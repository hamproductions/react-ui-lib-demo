 ...
 */
export function instanceOfLocationGameIndex(
  value: object
): value is LocationGameIndex {
...
export function LocationGameIndexFromJSONTyped(
  json: any,
...
export function LocationGameIndexToJSON(value?: LocationGameIndex | null): any {
  if (value == null) {
    return value;
  }
  return {
