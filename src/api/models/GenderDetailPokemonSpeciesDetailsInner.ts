 ...
 */
export function instanceOfGenderDetailPokemonSpeciesDetailsInner(
  value: object
): value is GenderDetailPokemonSpeciesDetailsInner {
...
export function GenderDetailPokemonSpeciesDetailsInnerFromJSON(
  json: any
): GenderDetailPokemonSpeciesDetailsInner {
  return GenderDetailPokemonSpeciesDetailsInnerFromJSONTyped(json, false);
}

export function GenderDetailPokemonSpeciesDetailsInnerFromJSONTyped(
  json: any,
...
export function GenderDetailPokemonSpeciesDetailsInnerToJSON(
  value?: GenderDetailPokemonSpeciesDetailsInner | null
): any {
  if (value == null) {
    return value;
  }
