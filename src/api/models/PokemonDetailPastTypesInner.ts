 ...
 */
export function instanceOfPokemonDetailPastTypesInner(
  value: object
): value is PokemonDetailPastTypesInner {
...
export function PokemonDetailPastTypesInnerFromJSON(
  json: any
): PokemonDetailPastTypesInner {
  return PokemonDetailPastTypesInnerFromJSONTyped(json, false);
}

export function PokemonDetailPastTypesInnerFromJSONTyped(
  json: any,
...
export function PokemonDetailPastTypesInnerToJSON(
  value?: PokemonDetailPastTypesInner | null
): any {
  if (value == null) {
    return value;
  }
