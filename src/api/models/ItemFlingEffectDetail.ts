 ...
 */
export function instanceOfItemFlingEffectDetail(
  value: object
): value is ItemFlingEffectDetail {
...
export function ItemFlingEffectDetailFromJSON(
  json: any
): ItemFlingEffectDetail {
  return ItemFlingEffectDetailFromJSONTyped(json, false);
}

export function ItemFlingEffectDetailFromJSONTyped(
  json: any,
...
export function ItemFlingEffectDetailToJSON(
  value?: Omit<ItemFlingEffectDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
