 ...
 */
export function instanceOfPaginatedRegionSummaryList(
  value: object
): value is PaginatedRegionSummaryList {
  return true;
}

export function PaginatedRegionSummaryListFromJSON(
  json: any
): PaginatedRegionSummaryList {
  return PaginatedRegionSummaryListFromJSONTyped(json, false);
}

export function PaginatedRegionSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(RegionSummaryFromJSON),
  };
}

export function PaginatedRegionSummaryListToJSON(
  value?: PaginatedRegionSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(RegionSummaryToJSON),
  };
}
