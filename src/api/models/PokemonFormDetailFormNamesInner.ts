 ...
 */
export function instanceOfPokemonFormDetailFormNamesInner(
  value: object
): value is PokemonFormDetailFormNamesInner {
  if (!("language" in value) || value["language"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  return true;
}

export function PokemonFormDetailFormNamesInnerFromJSON(
  json: any
): PokemonFormDetailFormNamesInner {
  return PokemonFormDetailFormNamesInnerFromJSONTyped(json, false);
}

export function PokemonFormDetailFormNamesInnerFromJSONTyped(
  json: any,
...
export function PokemonFormDetailFormNamesInnerToJSON(
  value?: PokemonFormDetailFormNamesInner | null
): any {
  if (value == null) {
    return value;
  }
