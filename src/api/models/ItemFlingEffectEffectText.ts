 ...
 */
export function instanceOfItemFlingEffectEffectText(
  value: object
): value is ItemFlingEffectEffectText {
  if (!("effect" in value) || value["effect"] === undefined) return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function ItemFlingEffectEffectTextFromJSON(
  json: any
): ItemFlingEffectEffectText {
  return ItemFlingEffectEffectTextFromJSONTyped(json, false);
}

export function ItemFlingEffectEffectTextFromJSONTyped(
  json: any,
...
export function ItemFlingEffectEffectTextToJSON(
  value?: ItemFlingEffectEffectText | null
): any {
  if (value == null) {
    return value;
  }
