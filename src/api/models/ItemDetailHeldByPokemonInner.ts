 ...
 */
export function instanceOfItemDetailHeldByPokemonInner(
  value: object
): value is ItemDetailHeldByPokemonInner {
...
export function ItemDetailHeldByPokemonInnerFromJSON(
  json: any
): ItemDetailHeldByPokemonInner {
  return ItemDetailHeldByPokemonInnerFromJSONTyped(json, false);
}

export function ItemDetailHeldByPokemonInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    versionDetails: (json["version-details"] as Array<any>).map(
      ItemDetailHeldByPokemonInnerVersionDetailsInnerFromJSON
    ),
  };
}

export function ItemDetailHeldByPokemonInnerToJSON(
  value?: ItemDetailHeldByPokemonInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    "version-details": (value["versionDetails"] as Array<any>).map(
      ItemDetailHeldByPokemonInnerVersionDetailsInnerToJSON
    ),
  };
}
