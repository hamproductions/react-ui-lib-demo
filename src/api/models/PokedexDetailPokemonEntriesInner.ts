 ...
 */
export function instanceOfPokedexDetailPokemonEntriesInner(
  value: object
): value is PokedexDetailPokemonEntriesInner {
  if (!("entryNumber" in value) || value["entryNumber"] === undefined)
    return false;
...
export function PokedexDetailPokemonEntriesInnerFromJSON(
  json: any
): PokedexDetailPokemonEntriesInner {
  return PokedexDetailPokemonEntriesInnerFromJSONTyped(json, false);
}

export function PokedexDetailPokemonEntriesInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    pokemonSpecies: AbilityDetailPokemonInnerPokemonFromJSON(
      json["pokemon_species"]
    ),
  };
}

export function PokedexDetailPokemonEntriesInnerToJSON(
  value?: PokedexDetailPokemonEntriesInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    pokemon_species: AbilityDetailPokemonInnerPokemonToJSON(
