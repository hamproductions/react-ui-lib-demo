 ...
 */
export function instanceOfAbilityEffectText(
  value: object
): value is AbilityEffectText {
...
export function AbilityEffectTextFromJSONTyped(
  json: any,
...
export function AbilityEffectTextToJSON(value?: AbilityEffectText | null): any {
  if (value == null) {
    return value;
  }
  return {
