 ...
 */
export function instanceOfPaginatedContestTypeSummaryList(
  value: object
): value is PaginatedContestTypeSummaryList {
  return true;
}

export function PaginatedContestTypeSummaryListFromJSON(
  json: any
): PaginatedContestTypeSummaryList {
  return PaginatedContestTypeSummaryListFromJSONTyped(json, false);
}

export function PaginatedContestTypeSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(ContestTypeSummaryFromJSON),
  };
}

export function PaginatedContestTypeSummaryListToJSON(
  value?: PaginatedContestTypeSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(ContestTypeSummaryToJSON),
  };
}
