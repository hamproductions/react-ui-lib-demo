 ...
 */
export function instanceOfEncounterConditionValueDetail(
  value: object
): value is EncounterConditionValueDetail {
...
export function EncounterConditionValueDetailFromJSON(
  json: any
): EncounterConditionValueDetail {
  return EncounterConditionValueDetailFromJSONTyped(json, false);
}

export function EncounterConditionValueDetailFromJSONTyped(
  json: any,
...
export function EncounterConditionValueDetailToJSON(
  value?: Omit<EncounterConditionValueDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
