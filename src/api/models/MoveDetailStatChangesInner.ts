 ...
 */
export function instanceOfMoveDetailStatChangesInner(
  value: object
): value is MoveDetailStatChangesInner {
  if (!("change" in value) || value["change"] === undefined) return false;
  if (!("stat" in value) || value["stat"] === undefined) return false;
  return true;
}

export function MoveDetailStatChangesInnerFromJSON(
  json: any
): MoveDetailStatChangesInner {
  return MoveDetailStatChangesInnerFromJSONTyped(json, false);
}

export function MoveDetailStatChangesInnerFromJSONTyped(
  json: any,
...
export function MoveDetailStatChangesInnerToJSON(
  value?: MoveDetailStatChangesInner | null
): any {
  if (value == null) {
    return value;
  }
