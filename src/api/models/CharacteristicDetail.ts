 ...
 */
export function instanceOfCharacteristicDetail(
  value: object
): value is CharacteristicDetail {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("geneModulo" in value) || value["geneModulo"] === undefined)
    return false;
  if (!("possibleValues" in value) || value["possibleValues"] === undefined)
    return false;
  if (!("highestStat" in value) || value["highestStat"] === undefined)
    return false;
...
export function CharacteristicDetailFromJSONTyped(
  json: any,
...
export function CharacteristicDetailToJSON(
  value?: Omit<CharacteristicDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
