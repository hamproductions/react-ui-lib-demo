...
import type { ContestTypeDetailBerryFlavor } from "./ContestTypeDetailBerryFlavor";
import {
  ContestTypeDetailBerryFlavorFromJSON,
  ContestTypeDetailBerryFlavorFromJSONTyped,
  ContestTypeDetailBerryFlavorToJSON,
} from "./ContestTypeDetailBerryFlavor";
 ...
 */
export function instanceOfContestTypeDetail(
  value: object
): value is ContestTypeDetail {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("berryFlavor" in value) || value["berryFlavor"] === undefined)
    return false;
...
export function ContestTypeDetailFromJSONTyped(
  json: any,
  ...
  return {
    id: json["id"],
    name: json["name"],
    berryFlavor: ContestTypeDetailBerryFlavorFromJSON(json["berry_flavor"]),
    names: (json["names"] as Array<any>).map(ContestTypeNameFromJSON),
  };
}

export function ContestTypeDetailToJSON(
  value?: Omit<ContestTypeDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
  return {
    name: value["name"],
    berry_flavor: ContestTypeDetailBerryFlavorToJSON(value["berryFlavor"]),
