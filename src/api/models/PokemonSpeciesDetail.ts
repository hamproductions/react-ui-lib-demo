 ...
 */
export function instanceOfPokemonSpeciesDetail(
  value: object
): value is PokemonSpeciesDetail {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("growthRate" in value) || value["growthRate"] === undefined)
    return false;
  if (!("pokedexNumbers" in value) || value["pokedexNumbers"] === undefined)
    return false;
  ...
  if (
    !("evolvesFromSpecies" in value) ||
    value["evolvesFromSpecies"] === undefined
  )
    return false;
  if (!("evolutionChain" in value) || value["evolutionChain"] === undefined)
    return false;
  ...
  if (
    !("palParkEncounters" in value) ||
    value["palParkEncounters"] === undefined
  )
    return false;
  if (!("formDescriptions" in value) || value["formDescriptions"] === undefined)
    return false;
  if (
    !("flavorTextEntries" in value) ||
    value["flavorTextEntries"] === undefined
  )
    return false;
...
export function PokemonSpeciesDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    captureRate:
      json["capture_rate"] == null ? undefined : json["capture_rate"],
    baseHappiness:
      json["base_happiness"] == null ? undefined : json["base_happiness"],
    isBaby: json["is_baby"] == null ? undefined : json["is_baby"],
    isLegendary:
      json["is_legendary"] == null ? undefined : json["is_legendary"],
    isMythical: json["is_mythical"] == null ? undefined : json["is_mythical"],
    hatchCounter:
      json["hatch_counter"] == null ? undefined : json["hatch_counter"],
    hasGenderDifferences:
      json["has_gender_differences"] == null
        ? undefined
        : json["has_gender_differences"],
    formsSwitchable:
      json["forms_switchable"] == null ? undefined : json["forms_switchable"],
    growthRate: GrowthRateSummaryFromJSON(json["growth_rate"]),
    pokedexNumbers: (json["pokedex_numbers"] as Array<any>).map(
      PokemonDexEntryFromJSON
    ),
    eggGroups: (json["egg_groups"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonFromJSON
    ),
    color: PokemonColorSummaryFromJSON(json["color"]),
    shape: PokemonShapeSummaryFromJSON(json["shape"]),
    evolvesFromSpecies: PokemonSpeciesSummaryFromJSON(
    ...
    palParkEncounters: (json["pal_park_encounters"] as Array<any>).map(
      PokemonSpeciesDetailPalParkEncountersInnerFromJSON
    ),
    formDescriptions: (json["form_descriptions"] as Array<any>).map(
      PokemonSpeciesDescriptionFromJSON
    ),
    flavorTextEntries: (json["flavor_text_entries"] as Array<any>).map(
      PokemonSpeciesFlavorTextFromJSON
    ),
    genera: (json["genera"] as Array<any>).map(
      PokemonSpeciesDetailGeneraInnerFromJSON
    ),
    varieties: (json["varieties"] as Array<any>).map(
      PokemonSpeciesDetailVarietiesInnerFromJSON
    ),
  };
}

export function PokemonSpeciesDetailToJSON(
  value?: Omit<PokemonSpeciesDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    pokedex_numbers: (value["pokedexNumbers"] as Array<any>).map(
      PokemonDexEntryToJSON
    ),
    egg_groups: (value["eggGroups"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonToJSON
    ),
    color: PokemonColorSummaryToJSON(value["color"]),
    shape: PokemonShapeSummaryToJSON(value["shape"]),
    evolves_from_species: PokemonSpeciesSummaryToJSON(
      value["evolvesFromSpecies"]
    ),
    ...
    pal_park_encounters: (value["palParkEncounters"] as Array<any>).map(
      PokemonSpeciesDetailPalParkEncountersInnerToJSON
    ),
    form_descriptions: (value["formDescriptions"] as Array<any>).map(
      PokemonSpeciesDescriptionToJSON
    ),
    flavor_text_entries: (value["flavorTextEntries"] as Array<any>).map(
      PokemonSpeciesFlavorTextToJSON
    ),
    genera: (value["genera"] as Array<any>).map(
      PokemonSpeciesDetailGeneraInnerToJSON
    ),
    varieties: (value["varieties"] as Array<any>).map(
      PokemonSpeciesDetailVarietiesInnerToJSON
    ),
  };
}
