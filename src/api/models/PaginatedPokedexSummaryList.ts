 ...
 */
export function instanceOfPaginatedPokedexSummaryList(
  value: object
): value is PaginatedPokedexSummaryList {
  return true;
}

export function PaginatedPokedexSummaryListFromJSON(
  json: any
): PaginatedPokedexSummaryList {
  return PaginatedPokedexSummaryListFromJSONTyped(json, false);
}

export function PaginatedPokedexSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(PokedexSummaryFromJSON),
  };
}

export function PaginatedPokedexSummaryListToJSON(
  value?: PaginatedPokedexSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(PokedexSummaryToJSON),
  };
}
