 ...
 */
export function instanceOfPaginatedMoveTargetSummaryList(
  value: object
): value is PaginatedMoveTargetSummaryList {
  return true;
}

export function PaginatedMoveTargetSummaryListFromJSON(
  json: any
): PaginatedMoveTargetSummaryList {
  return PaginatedMoveTargetSummaryListFromJSONTyped(json, false);
}

export function PaginatedMoveTargetSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(MoveTargetSummaryFromJSON),
  };
}

export function PaginatedMoveTargetSummaryListToJSON(
  value?: PaginatedMoveTargetSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(MoveTargetSummaryToJSON),
  };
}
