 ...
 */
export function instanceOfItemDetailMachinesInner(
  value: object
): value is ItemDetailMachinesInner {
...
export function ItemDetailMachinesInnerFromJSON(
  json: any
): ItemDetailMachinesInner {
  return ItemDetailMachinesInnerFromJSONTyped(json, false);
}

export function ItemDetailMachinesInnerFromJSONTyped(
  json: any,
...
export function ItemDetailMachinesInnerToJSON(
  value?: ItemDetailMachinesInner | null
): any {
  if (value == null) {
    return value;
  }
