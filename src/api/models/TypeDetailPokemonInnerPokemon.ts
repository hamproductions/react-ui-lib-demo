 ...
 */
export function instanceOfTypeDetailPokemonInnerPokemon(
  value: object
): value is TypeDetailPokemonInnerPokemon {
  return true;
}

export function TypeDetailPokemonInnerPokemonFromJSON(
  json: any
): TypeDetailPokemonInnerPokemon {
  return TypeDetailPokemonInnerPokemonFromJSONTyped(json, false);
}

export function TypeDetailPokemonInnerPokemonFromJSONTyped(
  json: any,
...
export function TypeDetailPokemonInnerPokemonToJSON(
  value?: TypeDetailPokemonInnerPokemon | null
): any {
  if (value == null) {
    return value;
  }
