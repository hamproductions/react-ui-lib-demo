 ...
 */
export function instanceOfGenerationDetail(
  value: object
): value is GenerationDetail {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("abilities" in value) || value["abilities"] === undefined) return false;
  if (!("mainRegion" in value) || value["mainRegion"] === undefined)
    return false;
...
export function GenerationDetailFromJSONTyped(
  json: any,
...
export function GenerationDetailToJSON(
  value?: Omit<GenerationDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
