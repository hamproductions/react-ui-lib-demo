 ...
 */
export function instanceOfTypeDetailPastDamageRelationsInner(
  value: object
): value is TypeDetailPastDamageRelationsInner {
...
export function TypeDetailPastDamageRelationsInnerFromJSON(
  json: any
): TypeDetailPastDamageRelationsInner {
  return TypeDetailPastDamageRelationsInnerFromJSONTyped(json, false);
}

export function TypeDetailPastDamageRelationsInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    damageRelations: TypeDetailPastDamageRelationsInnerDamageRelationsFromJSON(
      json["damage_relations"]
    ),
  };
}

export function TypeDetailPastDamageRelationsInnerToJSON(
  value?: TypeDetailPastDamageRelationsInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    damage_relations: TypeDetailPastDamageRelationsInnerDamageRelationsToJSON(
      value["damageRelations"]
    ),
  };
}
