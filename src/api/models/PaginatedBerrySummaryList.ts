 ...
 */
export function instanceOfPaginatedBerrySummaryList(
  value: object
): value is PaginatedBerrySummaryList {
  return true;
}

export function PaginatedBerrySummaryListFromJSON(
  json: any
): PaginatedBerrySummaryList {
  return PaginatedBerrySummaryListFromJSONTyped(json, false);
}

export function PaginatedBerrySummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(BerrySummaryFromJSON),
  };
}

export function PaginatedBerrySummaryListToJSON(
  value?: PaginatedBerrySummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(BerrySummaryToJSON),
  };
}
