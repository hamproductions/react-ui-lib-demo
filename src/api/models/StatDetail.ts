...
export function instanceOfStatDetail(value: object): value is StatDetail {
  ...
  if (!("affectingMoves" in value) || value["affectingMoves"] === undefined)
    return false;
  if (!("affectingNatures" in value) || value["affectingNatures"] === undefined)
    return false;
  if (!("characteristics" in value) || value["characteristics"] === undefined)
    return false;
...
export function StatDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    affectingNatures: StatDetailAffectingNaturesFromJSON(
      json["affecting_natures"]
    ),
    characteristics: (json["characteristics"] as Array<any>).map(
      CharacteristicSummaryFromJSON
    ),
...
export function StatDetailToJSON(value?: Omit<StatDetail, "id"> | null): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    affecting_natures: StatDetailAffectingNaturesToJSON(
      value["affectingNatures"]
    ),
    characteristics: (value["characteristics"] as Array<any>).map(
      CharacteristicSummaryToJSON
    ),
