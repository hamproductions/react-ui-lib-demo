 ...
 */
export function instanceOfBerryFlavorDetail(
  value: object
): value is BerryFlavorDetail {
...
export function BerryFlavorDetailFromJSONTyped(
  json: any,
  ...
  return {
    id: json["id"],
    name: json["name"],
    berries: (json["berries"] as Array<any>).map(
      BerryFlavorDetailBerriesInnerFromJSON
    ),
...
export function BerryFlavorDetailToJSON(
  value?: Omit<BerryFlavorDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
  return {
    name: value["name"],
    berries: (value["berries"] as Array<any>).map(
      BerryFlavorDetailBerriesInnerToJSON
    ),
