 ...
 */
export function instanceOfAbilityChangeEffectText(
  value: object
): value is AbilityChangeEffectText {
  if (!("effect" in value) || value["effect"] === undefined) return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function AbilityChangeEffectTextFromJSON(
  json: any
): AbilityChangeEffectText {
  return AbilityChangeEffectTextFromJSONTyped(json, false);
}

export function AbilityChangeEffectTextFromJSONTyped(
  json: any,
...
export function AbilityChangeEffectTextToJSON(
  value?: AbilityChangeEffectText | null
): any {
  if (value == null) {
    return value;
  }
