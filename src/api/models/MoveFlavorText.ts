 ...
 */
export function instanceOfMoveFlavorText(
  value: object
): value is MoveFlavorText {
...
export function MoveFlavorTextFromJSONTyped(
  json: any,
...
export function MoveFlavorTextToJSON(value?: MoveFlavorText | null): any {
  if (value == null) {
    return value;
  }
  return {
