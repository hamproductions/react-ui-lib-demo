 ...
 */
export function instanceOfPokemonColorSummary(
  value: object
): value is PokemonColorSummary {
...
export function PokemonColorSummaryFromJSONTyped(
  json: any,
...
export function PokemonColorSummaryToJSON(
  value?: Omit<PokemonColorSummary, "url"> | null
): any {
  if (value == null) {
    return value;
  }
