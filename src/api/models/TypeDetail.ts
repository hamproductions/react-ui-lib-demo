...
export function instanceOfTypeDetail(value: object): value is TypeDetail {
  ...
  if (!("damageRelations" in value) || value["damageRelations"] === undefined)
    return false;
  if (
    !("pastDamageRelations" in value) ||
    value["pastDamageRelations"] === undefined
  )
    return false;
  ...
  if (!("generation" in value) || value["generation"] === undefined)
    return false;
  if (!("moveDamageClass" in value) || value["moveDamageClass"] === undefined)
    return false;
...
export function TypeDetailFromJSONTyped(
  json: any,
  ...
  return {
    id: json["id"],
    name: json["name"],
    damageRelations: TypeDetailDamageRelationsFromJSON(
      json["damage_relations"]
    ),
    pastDamageRelations: (json["past_damage_relations"] as Array<any>).map(
      TypeDetailPastDamageRelationsInnerFromJSON
    ),
    ...
    pokemon: (json["pokemon"] as Array<any>).map(
      TypeDetailPokemonInnerFromJSON
    ),
...
export function TypeDetailToJSON(value?: Omit<TypeDetail, "id"> | null): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    past_damage_relations: (value["pastDamageRelations"] as Array<any>).map(
      TypeDetailPastDamageRelationsInnerToJSON
    ),
