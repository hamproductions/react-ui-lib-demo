 ...
 */
export function instanceOfMoveMetaCategoryDetail(
  value: object
): value is MoveMetaCategoryDetail {
...
export function MoveMetaCategoryDetailFromJSON(
  json: any
): MoveMetaCategoryDetail {
  return MoveMetaCategoryDetailFromJSONTyped(json, false);
}

export function MoveMetaCategoryDetailFromJSONTyped(
  json: any,
...
export function MoveMetaCategoryDetailToJSON(
  value?: Omit<MoveMetaCategoryDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
