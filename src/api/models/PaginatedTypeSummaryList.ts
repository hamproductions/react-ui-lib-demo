 ...
 */
export function instanceOfPaginatedTypeSummaryList(
  value: object
): value is PaginatedTypeSummaryList {
  return true;
}

export function PaginatedTypeSummaryListFromJSON(
  json: any
): PaginatedTypeSummaryList {
  return PaginatedTypeSummaryListFromJSONTyped(json, false);
}

export function PaginatedTypeSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(TypeSummaryFromJSON),
  };
}

export function PaginatedTypeSummaryListToJSON(
  value?: PaginatedTypeSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(TypeSummaryToJSON),
  };
}
