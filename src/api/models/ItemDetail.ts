...
export function instanceOfItemDetail(value: object): value is ItemDetail {
  ...
  if (!("flingEffect" in value) || value["flingEffect"] === undefined)
    return false;
  ...
  if (
    ...
    return false;
  if (!("gameIndices" in value) || value["gameIndices"] === undefined)
    return false;
  if (!("names" in value) || value["names"] === undefined) return false;
  if (!("heldByPokemon" in value) || value["heldByPokemon"] === undefined)
    return false;
  if (!("sprites" in value) || value["sprites"] === undefined) return false;
  if (!("babyTriggerFor" in value) || value["babyTriggerFor"] === undefined)
    return false;
...
export function ItemDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    gameIndices: (json["game_indices"] as Array<any>).map(
      ItemGameIndexFromJSON
    ),
    names: (json["names"] as Array<any>).map(ItemNameFromJSON),
    heldByPokemon: (json["held_by_pokemon"] as Array<any>).map(
      ItemDetailHeldByPokemonInnerFromJSON
    ),
...
export function ItemDetailToJSON(value?: Omit<ItemDetail, "id"> | null): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    held_by_pokemon: (value["heldByPokemon"] as Array<any>).map(
      ItemDetailHeldByPokemonInnerToJSON
    ),
