 ...
 */
export function instanceOfSuperContestEffectFlavorText(
  value: object
): value is SuperContestEffectFlavorText {
  if (!("flavorText" in value) || value["flavorText"] === undefined)
    return false;
  if (!("language" in value) || value["language"] === undefined) return false;
  return true;
}

export function SuperContestEffectFlavorTextFromJSON(
  json: any
): SuperContestEffectFlavorText {
  return SuperContestEffectFlavorTextFromJSONTyped(json, false);
}

export function SuperContestEffectFlavorTextFromJSONTyped(
  json: any,
...
export function SuperContestEffectFlavorTextToJSON(
  value?: SuperContestEffectFlavorText | null
): any {
  if (value == null) {
    return value;
  }
