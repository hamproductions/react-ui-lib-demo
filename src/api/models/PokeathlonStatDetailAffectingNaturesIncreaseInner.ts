 ...
 */
export function instanceOfPokeathlonStatDetailAffectingNaturesIncreaseInner(
  value: object
): value is PokeathlonStatDetailAffectingNaturesIncreaseInner {
  if (!("maxChange" in value) || value["maxChange"] === undefined) return false;
  if (!("nature" in value) || value["nature"] === undefined) return false;
  return true;
}

export function PokeathlonStatDetailAffectingNaturesIncreaseInnerFromJSON(
  json: any
): PokeathlonStatDetailAffectingNaturesIncreaseInner {
  return PokeathlonStatDetailAffectingNaturesIncreaseInnerFromJSONTyped(
    json,
    false
  );
}

export function PokeathlonStatDetailAffectingNaturesIncreaseInnerFromJSONTyped(
  json: any,
...
export function PokeathlonStatDetailAffectingNaturesIncreaseInnerToJSON(
  value?: PokeathlonStatDetailAffectingNaturesIncreaseInner | null
): any {
  if (value == null) {
    return value;
  }
