 ...
 */
export function instanceOfPaginatedEncounterConditionValueSummaryList(
  value: object
): value is PaginatedEncounterConditionValueSummaryList {
  return true;
}

export function PaginatedEncounterConditionValueSummaryListFromJSON(
  json: any
): PaginatedEncounterConditionValueSummaryList {
  return PaginatedEncounterConditionValueSummaryListFromJSONTyped(json, false);
}

export function PaginatedEncounterConditionValueSummaryListFromJSONTyped(
  json: any,
...
export function PaginatedEncounterConditionValueSummaryListToJSON(
  value?: PaginatedEncounterConditionValueSummaryList | null
): any {
  if (value == null) {
    return value;
  }
