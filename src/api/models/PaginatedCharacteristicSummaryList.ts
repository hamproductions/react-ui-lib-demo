 ...
 */
export function instanceOfPaginatedCharacteristicSummaryList(
  value: object
): value is PaginatedCharacteristicSummaryList {
  return true;
}

export function PaginatedCharacteristicSummaryListFromJSON(
  json: any
): PaginatedCharacteristicSummaryList {
  return PaginatedCharacteristicSummaryListFromJSONTyped(json, false);
}

export function PaginatedCharacteristicSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(CharacteristicSummaryFromJSON),
  };
}

export function PaginatedCharacteristicSummaryListToJSON(
  value?: PaginatedCharacteristicSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(CharacteristicSummaryToJSON),
  };
}
