 ...
 */
export function instanceOfGenerationName(
  value: object
): value is GenerationName {
...
export function GenerationNameFromJSONTyped(
  json: any,
...
export function GenerationNameToJSON(value?: GenerationName | null): any {
  if (value == null) {
    return value;
  }
  return {
