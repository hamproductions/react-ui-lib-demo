 ...
 */
export function instanceOfEvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner(
  value: object
): value is EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner {
  ...
  if (!("knownMoveType" in value) || value["knownMoveType"] === undefined)
    return false;
  if (!("location" in value) || value["location"] === undefined) return false;
  if (!("minAffection" in value) || value["minAffection"] === undefined)
    return false;
  if (!("minBeauty" in value) || value["minBeauty"] === undefined) return false;
  if (!("minHappiness" in value) || value["minHappiness"] === undefined)
    return false;
  if (!("minLevel" in value) || value["minLevel"] === undefined) return false;
  if (
    !("needsOverworldRain" in value) ||
    value["needsOverworldRain"] === undefined
  )
    return false;
  if (!("partySpecies" in value) || value["partySpecies"] === undefined)
    return false;
  if (!("partyType" in value) || value["partyType"] === undefined) return false;
  if (
    !("relativePhysicalStats" in value) ||
    value["relativePhysicalStats"] === undefined
  )
    return false;
  if (!("timeOfDay" in value) || value["timeOfDay"] === undefined) return false;
  if (!("tradeSpecies" in value) || value["tradeSpecies"] === undefined)
    return false;
  if (!("trigger" in value) || value["trigger"] === undefined) return false;
  if (!("turnUpsideDown" in value) || value["turnUpsideDown"] === undefined)
    return false;
  return true;
}

export function EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerFromJSON(
  json: any
): EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner {
  return EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerFromJSONTyped(
    json,
    false
  );
}

export function EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    item: EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerGenderFromJSON(
      json["item"]
    ),
...
export function EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerToJSON(
  value?: EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    item: EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerGenderToJSON(
      value["item"]
    ),
