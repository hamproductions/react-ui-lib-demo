...
export function EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInnerToJSON(value?: EvolutionChainDetailChainEvolvesToInnerEvolutionDetailsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
