 ...
 */
export function instanceOfPaginatedMoveLearnMethodSummaryList(
  value: object
): value is PaginatedMoveLearnMethodSummaryList {
  return true;
}

export function PaginatedMoveLearnMethodSummaryListFromJSON(
  json: any
): PaginatedMoveLearnMethodSummaryList {
  return PaginatedMoveLearnMethodSummaryListFromJSONTyped(json, false);
}

export function PaginatedMoveLearnMethodSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(MoveLearnMethodSummaryFromJSON),
  };
}

export function PaginatedMoveLearnMethodSummaryListToJSON(
  value?: PaginatedMoveLearnMethodSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(MoveLearnMethodSummaryToJSON),
  };
}
