 ...
 */
export function instanceOfPokemonSpeciesDetailPalParkEncountersInner(
  value: object
): value is PokemonSpeciesDetailPalParkEncountersInner {
...
export function PokemonSpeciesDetailPalParkEncountersInnerFromJSON(
  json: any
): PokemonSpeciesDetailPalParkEncountersInner {
  return PokemonSpeciesDetailPalParkEncountersInnerFromJSONTyped(json, false);
}

export function PokemonSpeciesDetailPalParkEncountersInnerFromJSONTyped(
  json: any,
...
export function PokemonSpeciesDetailPalParkEncountersInnerToJSON(
  value?: PokemonSpeciesDetailPalParkEncountersInner | null
): any {
  if (value == null) {
    return value;
  }
