 ...
 */
export function instanceOfEvolutionChainDetailChain(
  value: object
): value is EvolutionChainDetailChain {
...
export function EvolutionChainDetailChainFromJSON(
  json: any
): EvolutionChainDetailChain {
  return EvolutionChainDetailChainFromJSONTyped(json, false);
}

export function EvolutionChainDetailChainFromJSONTyped(
  json: any,
  ...
  return {
    ...
    evolvesTo: (json["evolves_to"] as Array<any>).map(
      EvolutionChainDetailChainEvolvesToInnerFromJSON
    ),
    isBaby: json["is_baby"],
...
export function EvolutionChainDetailChainToJSON(
  value?: EvolutionChainDetailChain | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    evolves_to: (value["evolvesTo"] as Array<any>).map(
      EvolutionChainDetailChainEvolvesToInnerToJSON
    ),
