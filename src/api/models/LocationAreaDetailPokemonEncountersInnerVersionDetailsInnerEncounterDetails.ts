 ...
 */
export function instanceOfLocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetails(
  value: object
): value is LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetails {
...
export function LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetailsFromJSON(
  json: any
): LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetails {
  return LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetailsFromJSONTyped(
    json,
    false
  );
}

export function LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetailsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    conditionValues:
      json["condition_values"] == null
        ? undefined
        : AbilityDetailPokemonInnerPokemonFromJSON(json["condition_values"]),
    chance: json["chance"],
    method: AbilityDetailPokemonInnerPokemonFromJSON(json["method"]),
  };
}

export function LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetailsToJSON(
  value?: LocationAreaDetailPokemonEncountersInnerVersionDetailsInnerEncounterDetails | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    condition_values: AbilityDetailPokemonInnerPokemonToJSON(
