 ...
 */
export function instanceOfMoveTargetName(
  value: object
): value is MoveTargetName {
...
export function MoveTargetNameFromJSONTyped(
  json: any,
...
export function MoveTargetNameToJSON(value?: MoveTargetName | null): any {
  if (value == null) {
    return value;
  }
  return {
