 ...
 */
export function instanceOfItemEffectText(
  value: object
): value is ItemEffectText {
...
export function ItemEffectTextFromJSONTyped(
  json: any,
...
export function ItemEffectTextToJSON(value?: ItemEffectText | null): any {
  if (value == null) {
    return value;
  }
  return {
