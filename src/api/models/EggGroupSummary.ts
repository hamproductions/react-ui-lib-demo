 ...
 */
export function instanceOfEggGroupSummary(
  value: object
): value is EggGroupSummary {
...
export function EggGroupSummaryFromJSONTyped(
  json: any,
...
export function EggGroupSummaryToJSON(
  value?: Omit<EggGroupSummary, "url"> | null
): any {
  if (value == null) {
    return value;
  }
