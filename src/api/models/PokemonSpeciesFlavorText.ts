 ...
 */
export function instanceOfPokemonSpeciesFlavorText(
  value: object
): value is PokemonSpeciesFlavorText {
...
export function PokemonSpeciesFlavorTextFromJSON(
  json: any
): PokemonSpeciesFlavorText {
  return PokemonSpeciesFlavorTextFromJSONTyped(json, false);
}

export function PokemonSpeciesFlavorTextFromJSONTyped(
  json: any,
...
export function PokemonSpeciesFlavorTextToJSON(
  value?: PokemonSpeciesFlavorText | null
): any {
  if (value == null) {
    return value;
  }
