 ...
 */
export function instanceOfAbilitySummary(
  value: object
): value is AbilitySummary {
...
export function AbilitySummaryFromJSONTyped(
  json: any,
...
export function AbilitySummaryToJSON(
  value?: Omit<AbilitySummary, "url"> | null
): any {
  if (value == null) {
    return value;
  }
