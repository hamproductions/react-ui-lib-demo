 ...
 */
export function instanceOfMoveDamageClassDetail(
  value: object
): value is MoveDamageClassDetail {
...
export function MoveDamageClassDetailFromJSON(
  json: any
): MoveDamageClassDetail {
  return MoveDamageClassDetailFromJSONTyped(json, false);
}

export function MoveDamageClassDetailFromJSONTyped(
  json: any,
...
export function MoveDamageClassDetailToJSON(
  value?: Omit<MoveDamageClassDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
