 ...
 */
export function instanceOfVersionGroupDetail(
  value: object
): value is VersionGroupDetail {
  if (!("id" in value) || value["id"] === undefined) return false;
  if (!("name" in value) || value["name"] === undefined) return false;
  if (!("generation" in value) || value["generation"] === undefined)
    return false;
  if (!("moveLearnMethods" in value) || value["moveLearnMethods"] === undefined)
    return false;
...
export function VersionGroupDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    moveLearnMethods: (json["move_learn_methods"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonFromJSON
    ),
    pokedexes: (json["pokedexes"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonFromJSON
    ),
...
export function VersionGroupDetailToJSON(
  value?: Omit<VersionGroupDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    move_learn_methods: (value["moveLearnMethods"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonToJSON
    ),
    pokedexes: (value["pokedexes"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonToJSON
    ),
    regions: (value["regions"] as Array<any>).map(
      AbilityDetailPokemonInnerPokemonToJSON
    ),
