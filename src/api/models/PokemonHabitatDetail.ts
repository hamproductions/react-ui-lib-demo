 ...
 */
export function instanceOfPokemonHabitatDetail(
  value: object
): value is PokemonHabitatDetail {
...
export function PokemonHabitatDetailFromJSONTyped(
  json: any,
...
export function PokemonHabitatDetailToJSON(
  value?: Omit<PokemonHabitatDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
