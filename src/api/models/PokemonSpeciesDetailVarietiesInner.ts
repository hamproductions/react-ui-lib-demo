 ...
 */
export function instanceOfPokemonSpeciesDetailVarietiesInner(
  value: object
): value is PokemonSpeciesDetailVarietiesInner {
  if (!("isDefault" in value) || value["isDefault"] === undefined) return false;
  if (!("pokemon" in value) || value["pokemon"] === undefined) return false;
  return true;
}

export function PokemonSpeciesDetailVarietiesInnerFromJSON(
  json: any
): PokemonSpeciesDetailVarietiesInner {
  return PokemonSpeciesDetailVarietiesInnerFromJSONTyped(json, false);
}

export function PokemonSpeciesDetailVarietiesInnerFromJSONTyped(
  json: any,
...
export function PokemonSpeciesDetailVarietiesInnerToJSON(
  value?: PokemonSpeciesDetailVarietiesInner | null
): any {
  if (value == null) {
    return value;
  }
