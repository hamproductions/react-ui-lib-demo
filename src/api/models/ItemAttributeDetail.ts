 ...
 */
export function instanceOfItemAttributeDetail(
  value: object
): value is ItemAttributeDetail {
...
export function ItemAttributeDetailFromJSONTyped(
  json: any,
...
export function ItemAttributeDetailToJSON(
  value?: Omit<ItemAttributeDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
