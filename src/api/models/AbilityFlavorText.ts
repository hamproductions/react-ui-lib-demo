 ...
 */
export function instanceOfAbilityFlavorText(
  value: object
): value is AbilityFlavorText {
...
export function AbilityFlavorTextFromJSONTyped(
  json: any,
...
export function AbilityFlavorTextToJSON(value?: AbilityFlavorText | null): any {
  if (value == null) {
    return value;
  }
  return {
