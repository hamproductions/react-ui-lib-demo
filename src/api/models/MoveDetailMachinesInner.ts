 ...
 */
export function instanceOfMoveDetailMachinesInner(
  value: object
): value is MoveDetailMachinesInner {
...
export function MoveDetailMachinesInnerFromJSON(
  json: any
): MoveDetailMachinesInner {
  return MoveDetailMachinesInnerFromJSONTyped(json, false);
}

export function MoveDetailMachinesInnerFromJSONTyped(
  json: any,
...
export function MoveDetailMachinesInnerToJSON(
  value?: MoveDetailMachinesInner | null
): any {
  if (value == null) {
    return value;
  }
