 ...
 */
export function instanceOfEncounterConditionDetail(
  value: object
): value is EncounterConditionDetail {
...
export function EncounterConditionDetailFromJSON(
  json: any
): EncounterConditionDetail {
  return EncounterConditionDetailFromJSONTyped(json, false);
}

export function EncounterConditionDetailFromJSONTyped(
  json: any,
...
export function EncounterConditionDetailToJSON(
  value?: Omit<EncounterConditionDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
