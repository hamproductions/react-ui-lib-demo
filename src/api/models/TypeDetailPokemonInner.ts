 ...
 */
export function instanceOfTypeDetailPokemonInner(
  value: object
): value is TypeDetailPokemonInner {
  return true;
}

export function TypeDetailPokemonInnerFromJSON(
  json: any
): TypeDetailPokemonInner {
  return TypeDetailPokemonInnerFromJSONTyped(json, false);
}

export function TypeDetailPokemonInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    pokemon:
      json["pokemon"] == null
        ? undefined
        : TypeDetailPokemonInnerPokemonFromJSON(json["pokemon"]),
  };
}

export function TypeDetailPokemonInnerToJSON(
  value?: TypeDetailPokemonInner | null
): any {
  if (value == null) {
    return value;
  }
