 ...
 */
export function instanceOfLocationDetail(
  value: object
...
export function LocationDetailFromJSONTyped(
  json: any,
...
export function LocationDetailToJSON(
  value?: Omit<LocationDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
