 ...
 */
export function instanceOfItemAttributeSummary(
  value: object
): value is ItemAttributeSummary {
...
export function ItemAttributeSummaryFromJSONTyped(
  json: any,
...
export function ItemAttributeSummaryToJSON(
  value?: Omit<ItemAttributeSummary, "url"> | null
): any {
  if (value == null) {
    return value;
  }
