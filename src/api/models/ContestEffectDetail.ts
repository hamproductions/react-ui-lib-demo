 ...
 */
export function instanceOfContestEffectDetail(
  value: object
): value is ContestEffectDetail {
...
export function ContestEffectDetailFromJSONTyped(
  json: any,
...
export function ContestEffectDetailToJSON(
  value?: Omit<ContestEffectDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
