 ...
 */
export function instanceOfPokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInner(
  value: object
): value is PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInner {
  if (!("chance" in value) || value["chance"] === undefined) return false;
  if (!("conditionValues" in value) || value["conditionValues"] === undefined)
    return false;
...
export function PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerFromJSON(
  json: any
): PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInner {
  return PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerFromJSONTyped(
    json,
    false
  );
}

export function PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerFromJSONTyped(
  json: any,
  ...
  return {
    chance: json["chance"],
    conditionValues: (json["condition_values"] as Array<any>).map(
      PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerConditionValuesInnerFromJSON
    ),
...
export function PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerToJSON(
  value?: PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInner | null
): any {
  if (value == null) {
    return value;
  }
  return {
    chance: value["chance"],
    condition_values: (value["conditionValues"] as Array<any>).map(
      PokemonEncountersRetrieve200ResponseInnerVersionDetailsInnerEncounterDetailsInnerConditionValuesInnerToJSON
    ),
