 ...
 */
export function instanceOfGrowthRateDetail(
  value: object
): value is GrowthRateDetail {
...
export function GrowthRateDetailFromJSONTyped(
  json: any,
...
export function GrowthRateDetailToJSON(
  value?: Omit<GrowthRateDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
