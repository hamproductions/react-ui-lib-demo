 ...
 */
export function instanceOfItemPocketDetail(
  value: object
): value is ItemPocketDetail {
...
export function ItemPocketDetailFromJSONTyped(
  json: any,
...
export function ItemPocketDetailToJSON(
  value?: Omit<ItemPocketDetail, "id"> | null
): any {
  if (value == null) {
    return value;
  }
