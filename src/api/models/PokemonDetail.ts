...
export function instanceOfPokemonDetail(value: object): value is PokemonDetail {
  ...
  if (!("pastAbilities" in value) || value["pastAbilities"] === undefined)
    return false;
  ...
  if (
    !("locationAreaEncounters" in value) ||
    value["locationAreaEncounters"] === undefined
  )
    return false;
...
export function PokemonDetailFromJSONTyped(
  json: any,
  ...
  return {
    ...
    name: json["name"],
    baseExperience:
      json["base_experience"] == null ? undefined : json["base_experience"],
    ...
    pastAbilities: (json["past_abilities"] as Array<any>).map(
      PokemonDetailPastAbilitiesInnerFromJSON
    ),
    ...
    pastTypes: (json["past_types"] as Array<any>).map(
      PokemonDetailPastTypesInnerFromJSON
    ),
  };
}

export function PokemonDetailToJSON(
  value?: Omit<PokemonDetail, "id" | "location_area_encounters"> | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    order: value["order"],
    weight: value["weight"],
    abilities: (value["abilities"] as Array<any>).map(
      PokemonDetailAbilitiesInnerToJSON
    ),
    past_abilities: (value["pastAbilities"] as Array<any>).map(
      PokemonDetailPastAbilitiesInnerToJSON
    ),
    forms: (value["forms"] as Array<any>).map(PokemonFormSummaryToJSON),
    game_indices: (value["gameIndices"] as Array<any>).map(
      PokemonGameIndexToJSON
    ),
    ...
    past_types: (value["pastTypes"] as Array<any>).map(
      PokemonDetailPastTypesInnerToJSON
    ),
  };
}
