 ...
 */
export function instanceOfPaginatedLanguageSummaryList(
  value: object
): value is PaginatedLanguageSummaryList {
  return true;
}

export function PaginatedLanguageSummaryListFromJSON(
  json: any
): PaginatedLanguageSummaryList {
  return PaginatedLanguageSummaryListFromJSONTyped(json, false);
}

export function PaginatedLanguageSummaryListFromJSONTyped(
  json: any,
  ...
  return {
    ...
    results:
      json["results"] == null
        ? undefined
        : (json["results"] as Array<any>).map(LanguageSummaryFromJSON),
  };
}

export function PaginatedLanguageSummaryListToJSON(
  value?: PaginatedLanguageSummaryList | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    results:
      value["results"] == null
        ? undefined
        : (value["results"] as Array<any>).map(LanguageSummaryToJSON),
  };
}
